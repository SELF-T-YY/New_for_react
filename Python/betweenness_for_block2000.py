...
with open(r'../data/fb-pages-public-figure/fppf_id_x_y_kde_edges.json') as f:
    ...
    f_file = open(r'../data/fb-pages-public-figure/fppf_id_x_y_kde_edges_betweenness.json', 'w+')

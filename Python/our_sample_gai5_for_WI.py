#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2020/2/18 21:14
# @Author  : SELF-T-YY
# @Site    : 
# @File    : our_sample_gai5_for_WI.py
# @Software: PyCharm
...
def run():
    for times in range(0,5):
        with open(file_path) as f:
            ...
            # print(ans_list)
            print(max_len, '%', sep='')
            f_file_path = r'../data/' + position + '/our_sample_adv/our_sample_times_' + str(times) + '_a_0.5_b_0.5_rata_' + str(per) + '.json'
            print(f_file_path)

#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2020/1/22 15:01
# @Author  : SELF-T-YY
# @Site    : 
# @File    : our_sample_gai5_for_ca-HepPh.py
# @Software: PyCharm
...
all_data_dict = json.load(open('../data/ca-HepPh.txt/ca-HepPh_forceData.json'))
all_edges_dict = all_data_dict['edges']
all_nodes_dict = json.load((open('../data/ca-HepPh.txt/ca-HepPh_id_x_y_kde.json')))
...
with open(r'../data/ca-HepPh.txt/ca-HepPh_id_x_y_kde_edges_betweenness.json') as f:
    alpha = 0.1
    ra = 30
    ...
    print(ans_list)
    print(max_len, '%', sep='')
    f_file = open(r'../data/ca-HepPh.txt/our_sample/our_sample_gai_a_0.1_b_0.9_rata_' + str(per) + '.json', 'w+')
